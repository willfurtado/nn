...
class Trainer:
    ...
    def _run_epoch(self) -> None:
        ...
        """
        X_batches, y_batches = self.dataset.create_batches(batch_size=self.batch_size)
        ...
        for X_batch, y_batch in zip(X_batches, y_batches):
            ...
            self.W = [
                W - self.learning_rate * grad_W for grad_W, W in zip(grad_Ws, self.W)
            ]
            self.b = [
                b - self.learning_rate * grad_b for grad_b, b in zip(grad_bs, self.b)
            ]
